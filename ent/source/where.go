...
func DeletedAt(v time.Time) predicate.Source {
	return predicate.Source(sql.FieldEQ(FieldDeletedAt, v))
}
...
func HasSourceEarthquakesWith(preds ...predicate.SourceEarthquake) predicate.Source {
	return predicate.Source(func(s *sql.Selector) {
