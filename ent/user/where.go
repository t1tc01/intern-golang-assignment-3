...
// HasPasswordResetRequest applies the HasEdge predicate on the "password_reset_request" edge.
func HasPasswordResetRequest() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPasswordResetRequestWith applies the HasEdge predicate on the "password_reset_request" edge with a given conditions (other predicates).
func HasPasswordResetRequestWith(preds ...predicate.PasswordResetRequest) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newPasswordResetRequestStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasCredentialsWith(preds ...predicate.Credentials) predicate.User {
	return predicate.User(func(s *sql.Selector) {
