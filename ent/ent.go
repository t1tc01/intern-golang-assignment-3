...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			apireq.Table:               apireq.ValidColumn,
			credentials.Table:          credentials.ValidColumn,
			earthquake.Table:           earthquake.ValidColumn,
			featuretype.Table:          featuretype.ValidColumn,
			ftypeearthquake.Table:      ftypeearthquake.ValidColumn,
			geometry.Table:             geometry.ValidColumn,
			location.Table:             location.ValidColumn,
			passwordresetrequest.Table: passwordresetrequest.ValidColumn,
			report.Table:               report.ValidColumn,
			session.Table:              session.ValidColumn,
			source.Table:               source.ValidColumn,
			sourceearthquake.Table:     sourceearthquake.ValidColumn,
