...
func (e ReportEdges) EarthquakesOrErr() ([]*Earthquake, error) {
	if e.loadedTypes[0] {
...
func (*Report) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case report.FieldCdi, report.FieldMmi:
			values[i] = new(sql.NullFloat64)
		case report.FieldID, report.FieldFelt:
			values[i] = new(sql.NullInt64)
		case report.FieldAlert:
			values[i] = new(sql.NullString)
		case report.FieldCreatedAt, report.FieldUpdatedAt, report.FieldDeletedAt:
...
// QueryEarthquakes queries the "earthquakes" edge of the Report entity.
func (r *Report) QueryEarthquakes() *EarthquakeQuery {
	return NewReportClient(r.config).QueryEarthquakes(r)
}
...
func (r *Report) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", r.Felt))
	builder.WriteString(", ")
	builder.WriteString("cdi=")
	builder.WriteString(fmt.Sprintf("%v", r.Cdi))
	builder.WriteString(", ")
	builder.WriteString("mmi=")
	builder.WriteString(fmt.Sprintf("%v", r.Mmi))
	builder.WriteString(", ")
	builder.WriteString("alert=")
	builder.WriteString(r.Alert)
	builder.WriteString(", ")
